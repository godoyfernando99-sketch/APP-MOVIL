...
class ScanResult {
  ...
  static ScanResult fromJson(Map<String, dynamic> json) {
    final photos = (json['photosBase64'] is List) ? (json['photosBase64'] as List).map((e) => e.toString()).toList() : <String>[];
    final createdAtRaw = json['createdAt'];
    final updatedAtRaw = json['updatedAt'];
    
    // Manejar tanto Timestamp de Firebase como String ISO8601 de local storage
